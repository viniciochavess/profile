        ...
        <>
            <section>
                ...
                <div className={classes.container}>
                    ...
                    <Image src={node.src} width={50} height={50} alt='logo do node'/>
                    <Image src={fastify.src} width={50} height={50} alt='logo do fastify'/>
                    <Image src={react.src} width={50} height={50} alt='logo do react'/>
                    <Image src={rn.src} width={50} height={50} alt='logo do react native'/>
                    <Image src={express.src} width={50} height={50} alt='logo do express'/>
                    <Image src={prisma.src} width={50} height={50} alt='logo do prisma'/>
                    <Image src={postg.src} width={50} height={50} alt='logo do postgres sql'/>
